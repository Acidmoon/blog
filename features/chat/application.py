"""High-level public chat workflow owned by the chat feature."""
...
def send_public_chat_message(
    *,
    ...
    """Append a user message, call the model, and persist the complete exchange."""
    ...
    initial_title = None
    if needs_title:
        title_messages = list_chat_messages(visitor_id, session["id"]) if session is not None else []
